...
import ru.pyrinoff.somebot.examples.example1.exception.model.UserNullException;
import ru.pyrinoff.somebot.examples.example1.api.service.IUserService;
import ru.pyrinoff.somebot.examples.example1.exception.model.IdNullException;
import ru.pyrinoff.somebot.examples.example1.model.User;
import ru.pyrinoff.somebot.examples.example1.repository.UserRepository;
